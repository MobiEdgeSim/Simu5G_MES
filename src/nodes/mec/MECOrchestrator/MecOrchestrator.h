...
class MecOrchestrator : public cSimpleModule
{
    ...
    friend class OptimalSelectionBased;
    ...
    public:
        ...
        const std::vector<cModule*>& getMecHosts() const;//get the mechosts
    ...
    private:
        /*
         *  this method update the mechosts in the dynamic simulation
         */
        void updateMecHost();
