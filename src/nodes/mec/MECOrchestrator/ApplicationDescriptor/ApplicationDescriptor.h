...
class ApplicationDescriptor
{
     ...
     */
        ...
        /*
         * Used to store the IP address of the UE
         */
        std::string ueIpAddress_;
    ...
    public:
        ...
        /*
         * Used to set and get the IP address of the UE
         */
        std::string getUeIpAddress() const { return ueIpAddress_; }
        void setUeIpAddress(const std::string& ueIpAddress) { ueIpAddress_ = ueIpAddress; }
};
